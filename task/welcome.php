...
$sql = "SELECT id, username, passcode, mobileNo FROM admin where username='$myusername'";
...
<div class="outside">
			<fieldset class="view">
				...
				<div class="field">
					Password: <input type='text' class="txt" name='' value="<?php echo $password ; ?>" readonly style="margin-left:6px;">
				</div>
				<div class="field">
					Mobile: <input type='text' class="txt" name='' value="<?php echo $MobileNo; ?>" readonly style="margin-left:32px;">
				</div>
				<br><br>
			</fieldset>
		</div>
